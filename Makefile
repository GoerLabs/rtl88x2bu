...
CONFIG_PLATFORM_UNCSOC_UMS9620 = n

##############DYNAMIC CONFIGURATIONS#################
ifdef TARGET_PRODUCT
ifneq ($(filter ums9620_%, $(TARGET_PRODUCT)),)

ALL_PLATFORMS := $(strip $(sort $(filter CONFIG_PLATFORM_%, $(.VARIABLES))))
$(foreach P, $(ALL_PLATFORMS), $(eval $(P) = n))

CONFIG_PLATFORM_UNCSOC_UMS9620 = y
endif
endif
...
ifeq ($(CONFIG_PLATFORM_ARM_RV1106), y)
...
########### UNCSOC ################################
ifeq ($(CONFIG_PLATFORM_UNCSOC_UMS9620), y)

EXTRA_CFLAGS += -DCONFIG_PLATFORM_UNCSOC_UMS9620
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
# default setting for Android
EXTRA_CFLAGS += -DCONFIG_CONCURRENT_MODE
EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211
